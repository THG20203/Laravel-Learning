...
so I've added a dynamic check in for it. Page if ture and false if not true. -->

<a class="{{ request()->is("/") ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-gray-700 hover:text-white" }} rounded-md px-3 py-2 text-sm font-medium" aria-current="{{ request()->is("/") ? "page" : "false" }}">
